...
| FPGA area contains at least two socketed Studer-labelled programmable devices and a `PALC22V10L-25PC` programmable logic device marked `9353 000020`; their exact device identities/references are not legible in available photos. | High | Photos fpga/2700, 2702, 2703 |
...
| New board trace evidence places U17/P80C552 as the strongest system-leader candidate, the small `PALC22V10L-25PC` (`9353 000020`) in probable address-decoding/control/timing/glue logic around the XC3030, and the XC3030 as the probable encoder/interface scanner. | Medium-high for marking; medium for roles; exact equations/nets unresolved | Owner-provided trace evidence and `photo/image-1789743641546.jpg` |
| U17 XDATA `0xFFE1/0xFFE3` is a candidate FPGA/peripheral service-register window, possibly decoded or controlled by the PAL, not a proven Macintosh protocol; its `01/02/06/FF` values have state-dependent local effects. | High for code effects; medium for hardware role | U17 reachable disassembly, `U17_MAIN_PROGRAM_ARCHITECTURE.md`, `U17_HIGH_ADDRESS_MAILBOX.md` |
...
| New close-ups identify U18 as Toshiba `TC55257BSPL-10` and the battery-backed device as Dallas `DS1230Y-100`; `image-1789838864227.jpg` also shows U17. The supplied inventory identifies U13 as `SN75177AN`, while `image-1789838660551.jpg` visually appears to read `SN75174AN`; both are differential-interface devices, not ROMs. | High for visible markings; U13 suffix discrepancy and physical decode remain unresolved | Photos `image-1789838660551.jpg`, `image-1789838797019.jpg`, `image-1789838864227.jpg` |
