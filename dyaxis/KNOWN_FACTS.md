...
| New board trace evidence places U17/P80C552 as the system leader, the small `PALC22V10L-25PC` (`9353 000020`) as an XC3030 communication partner, and the XC3030 as the encoder/console-control scanner. | Medium-high for marking/role; exact nets unresolved | Owner-provided trace evidence and `photo/image-1789743641546.jpg` |
