...
- [Xilinx XC3000 Series Field-Programmable Gate Arrays data book](https://www.bitsavers.org/components/xilinx/fpga/XC3000/3000.pdf). Used to distinguish XC3000 master-serial, master-parallel and processor/peripheral configuration modes and to avoid treating the nearby PAL as a configuration PROM without trace evidence.
- [PALCE22V10 family data sheet](https://www.latticesemi.com/-/media/LatticeSemi/Documents/DataSheets/PAL/PALCE22V10PALCE22V10ZDataSheet.ashx). Family/package reference for the visible `PALC22V10L-25PC` marking; the photographed device remains a programmable PAL/PLD, not a serial FPGA configuration PROM.
