...
| Main controller, battery-backed RAM | Dallas `DS1230Y-100` | Nonvolatile battery-backed SRAM | 32 KiB | Preservation-critical candidate for persistent upper application/data window; physical decode unresolved | — |
