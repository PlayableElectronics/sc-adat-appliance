...
define SC_ADAT_TONE_TEST_BUILD_CMDS
	...
	$(HOSTCC) $(@D)/make-synthdef.c -o $(@D)/make-synthdef
	$(@D)/make-synthdef $(@D)/sc-adat-tone.scsyndef
endef
define SC_ADAT_TONE_TEST_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -D -m 0644 $(BR2_EXTERNAL_SC_ADAT_APPLIANCE_PATH)/supercollider/sc-adat-tone.scd $(TARGET_DIR)/usr/share/sc-adat/sc-adat-tone.scd
	$(INSTALL) -D -m 0644 $(@D)/sc-adat-tone.scsyndef $(TARGET_DIR)/usr/share/sc-adat/sc-adat-tone.scsyndef
endef
